...
zerotwo_DATASET_LIST =    {{'230620-risqh-trot-02-036-33square',                0, 99},...
...
figure(1);
set(gcf,'color','w');
total_cells = size(zerotwo_DATASET_LIST,2);
...
for item_idx = 1:size(zerotwo_DATASET_LIST,2)
    data_info = zerotwo_DATASET_LIST{item_idx};
    ...
    zero2_total_drifts = [zero2_total_drifts; drifts_list];
    nexttile;
