...
one0_DATASET_LIST =    {{'230620-risqh-trot-10-036-33square',                0, 99},...
...
figure(1);
set(gcf,'color','w');
total_cells = size(one0_DATASET_LIST,2);
...
for item_idx = 1:size(one0_DATASET_LIST,2)
    data_info = one0_DATASET_LIST{item_idx};
    ...
    one0_total_drifts = [one0_total_drifts; drifts_list];
    nexttile;
