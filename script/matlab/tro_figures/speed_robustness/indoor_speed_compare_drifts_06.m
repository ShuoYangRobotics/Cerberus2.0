...
zero6_DATASET_LIST =    {{'230620-risqh-trot-06-036-33square',                0, 99},...
...
figure(1);
set(gcf,'color','w');
total_cells = size(zero6_DATASET_LIST,2);
...
for item_idx = 1:size(zero6_DATASET_LIST,2)
    data_info = zero6_DATASET_LIST{item_idx};
    ...
    zero6_total_drifts = [zero6_total_drifts; drifts_list];
    nexttile;
