...
zero8_DATASET_LIST =    {{'230620-risqh-trot-08-036-33square',                0, 99},...
...
figure(1);
set(gcf,'color','w');
total_cells = size(zero8_DATASET_LIST,2);
...
for item_idx = 1:size(zero8_DATASET_LIST,2)
    data_info = zero8_DATASET_LIST{item_idx};
    ...
    zero8_total_drifts = [zero8_total_drifts; drifts_list];
    nexttile;
