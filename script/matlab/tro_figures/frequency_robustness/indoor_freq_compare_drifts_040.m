...
zero40_DATASET_LIST =    {{'230620-risqh-trot-05-040-33square',                0, 99},...
...
figure(1);
set(gcf,'color','w');
total_cells = size(zero40_DATASET_LIST,2);
...
for item_idx = 1:size(zero40_DATASET_LIST,2)
    data_info = zero40_DATASET_LIST{item_idx};
    ...
    zero40_total_drifts = [zero40_total_drifts; drifts_list];
    nexttile;
