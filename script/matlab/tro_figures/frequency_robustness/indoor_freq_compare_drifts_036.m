...
zero36_DATASET_LIST =    {{'230620-risqh-trot-02-036-33square',                0, 99},...
                  {'230620-risqh-trot-04-036-33square',              0, 99},...
                  {'230620-risqh-trot-05-036-33square',              0, 99},...
                  ...
                  {'230620-risqh-trot-06-036-33square',              0, 99},...
                  {'230620-risqh-trot-08-036-33square',              0, 99},...
                  {'230625-risqh-flytrot-02-032-33square',              0, 99},...
                  ...
                  {'230620-risqh-trot-10-036-33square',              0, 99},...
                  {'230622-risqh-trot-08-036-33square',              0, 99},...
                  {'230625-risqh-trot-08-036-33square',              0, 99},...
                  ...
                  {'230622-risqh-trot-06-036-33square2',              0, 99},...
                  ...
                  ...
                  {'230625-risqh-standtrot-02-036-33square',              0, 99},...
...
figure(1);
set(gcf,'color','w');
total_cells = size(zero36_DATASET_LIST,2);

zero36_total_drifts = [];

t = tiledlayout(ceil(total_cells/ROW),ROW,'TileSpacing','Compact','Padding','Compact');
title('Experiments with gait frequency 0.36s')

for item_idx = 1:size(zero36_DATASET_LIST,2)
    data_info = zero36_DATASET_LIST{item_idx};
    ...
    zero36_total_drifts = [zero36_total_drifts; drifts_list];
    nexttile;
