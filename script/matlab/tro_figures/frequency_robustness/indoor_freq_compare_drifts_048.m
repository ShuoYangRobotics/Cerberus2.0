...
zero52_DATASET_LIST =    {{'230620-risqh-trot-05-052-33square',                0, 99},...
...
figure(1);
set(gcf,'color','w');
total_cells = size(zero52_DATASET_LIST,2);
...
for item_idx = 1:size(zero52_DATASET_LIST,2)
    data_info = zero52_DATASET_LIST{item_idx};
    ...
    zero52_total_drifts = [zero52_total_drifts; drifts_list];
    nexttile;
