...
zero44_DATASET_LIST =    {{'230620-risqh-trot-05-044-33square',                0, 99},...
...
figure(1);
set(gcf,'color','w');
total_cells = size(zero44_DATASET_LIST,2);
...
for item_idx = 1:size(zero44_DATASET_LIST,2)
    data_info = zero44_DATASET_LIST{item_idx};
    ...
    zero44_total_drifts = [zero44_total_drifts; drifts_list];
    nexttile;
