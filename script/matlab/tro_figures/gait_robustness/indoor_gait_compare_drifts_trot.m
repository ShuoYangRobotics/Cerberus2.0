...
TROT_DATASET_LIST =    {{'230620-risqh-trot-02-036-33square',                0, 99},...
                  {'230622-risqh-trot-02-040-33square',              0, 99},...
                  {'230622-risqh-trot-02-044-33square',              0, 99},...
                  {'230622-risqh-trot-02-048-33square',              0, 99},...
                  {'230622-risqh-trot-02-052-33square',              0, 60},...
                  ...
                  {'230620-risqh-trot-04-036-33square',              0, 99},...
                  ...
                  ...
                  {'230620-risqh-trot-06-036-33square',              0, 99},...
                  {'230622-risqh-trot-06-040-33square',              0, 99},...
                  {'230622-risqh-trot-06-044-33square',              0, 99},...
                  {'230622-risqh-trot-06-048-33square',              0, 99},...
                  {'230622-risqh-trot-06-052-33square',              0, 99},...
                  ...
                  {'230620-risqh-trot-08-036-33square',              0, 99},...
                  {'230622-risqh-trot-08-040-33square',              0, 99},...
                  {'230622-risqh-trot-08-044-33square',              0, 99},...
                  {'230620-risqh-trot-10-036-33square',              0, 99},...
                  {'230622-risqh-trot-10-040-33square',              0, 99}
                  };
...
set(gcf,'color','w');
total_cells = size(TROT_DATASET_LIST,2);
...
for item_idx = 1:size(TROT_DATASET_LIST,2)
    data_info = TROT_DATASET_LIST{item_idx};
    ...
    trot_total_drifts = [trot_total_drifts; drifts_list];
    nexttile;
