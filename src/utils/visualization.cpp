...
//     Eigen::Vector3d p_wb(estimator.Ps[WINDOW_SIZE].x(),
//                          estimator.Ps[WINDOW_SIZE].y(),
//                          estimator.Ps[WINDOW_SIZE].z());
//     Eigen::Vector3d v_wb(estimator.Vs[WINDOW_SIZE].x(),
//                          estimator.Vs[WINDOW_SIZE].y(),
//                          estimator.Vs[WINDOW_SIZE].z());
//     Eigen::Vector3d omega = estimator.latest_gyr_0 - estimator.latest_Bg;
//     Eigen::Vector3d p_wr =
//         p_wb + tmp_Q.toRotationMatrix() * estimator.R_br * estimator.p_br;

//     Eigen::Vector3d v_wr = v_wb + tmp_Q.toRotationMatrix() *
//                                       Utility::skewSymmetric(omega) *
//                                       estimator.R_br * estimator.p_br;

//     odometry.pose.pose.position.x = p_wr.x();
//     odometry.pose.pose.position.y = p_wr.y();
//     odometry.pose.pose.position.z = p_wr.z();
//     odometry.pose.pose.orientation.x =
//         tmp_Q.x(); // assume we know R_br is identity
...
//            estimator.Rho2[WINDOW_SIZE].x(), estimator.Rho3[WINDOW_SIZE].x(),
