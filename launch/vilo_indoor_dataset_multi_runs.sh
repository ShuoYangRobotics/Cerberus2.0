...
cp $ws_root/src/Cerberus2.0/config/go1_config/hardware_go1_vilo_config_indoor.yaml "$temp_config"
...
cp $ws_root/src/Cerberus/config/go1_config/hardware_go1_vilo_config_indoor.yaml "$temp_config"
